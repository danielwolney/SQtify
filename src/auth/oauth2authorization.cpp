...
bool OAuth2Authorization::hasAccess()
{
    return (!accessToken().isEmpty());
}

QString OAuth2Authorization::accessToken()
{
    return m_oAuthFlow->token();
}

void OAuth2Authorization::grantAccess()
{
    m_oAuthFlow->grant();
}

void OAuth2Authorization::refreshAccessToken()
{
...
QString OAuth2Authorization::readAccessToken()
{
    return getVar("at");
}

void OAuth2Authorization::saveAccessToken(QString token)
{
    saveVar("at", token);
}

QString OAuth2Authorization::readRefreshToken()
{
    return getVar("rt");
}

void OAuth2Authorization::saveRefreshToken(QString token)
{
    saveVar("rt", token);
}

void OAuth2Authorization::saveVar(QString varName, QString value)
{
...
QString OAuth2Authorization::getVar(QString varName)
{
